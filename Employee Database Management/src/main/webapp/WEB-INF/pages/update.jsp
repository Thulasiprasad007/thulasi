...
<div>
 <!--<img height = 200 width=200 src="<c:url value="/resources/images/reg.jpg"></c:url>"/>-->
	...
	<form:form id="form1" name="form1" modelAttribute="update1" method="post" action="update" onsubmit="return validateform()">
				...
				<td><fieldset style="border:none">
						...
						<table width="609" border="0" align="center">
							...
							<tr>
								...
								<td>&nbsp;</td>
								<td colspan="2"></td>
								<td colspan="3">Enter name you want to update<form:input type="text" name="txt_name" class="h1"
